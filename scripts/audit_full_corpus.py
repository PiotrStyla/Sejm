"""Run quality audit on the full merged speeches corpus."""
...
def main():
    corpus_path = Path(r"C:\Users\Hipek\CascadeProjects\Sejm\datasets\speeches_corpus.jsonl")
    ...
    result = auditor.run(
        ...
        dataset_name="speeches_corpus_full",
        purpose=(
            "Korpus wypowiedzi z posiedzen Sejmu RP (kadencja 10, 2023-2027) "
            "do treningu (CPT/SFT) modeli jezykowych polskiego — "
            "domena prawno-urzadowa/parlamentarna."
        ),
        source_description=(
            "Oficjalne API Sejmu (api.sejm.gov.pl), kadencja 10, "
            "wszystkie posiedzenia (161 dni z danymi)."
        ),
        license_note=(
